...
import com.guilin.flume.ng.sink.elasticsearch.client.ElasticSearchClient;
import com.guilin.flume.ng.sink.elasticsearch.client.ElasticSearchClientFactory;
...
public class ElasticSearchSink extends AbstractSink implements Configurable {
    ...
    public void start() {
        ...
        try {
            ...
            logger.info("es sink start success");
        } catch (Exception ex) {
            ex.printStackTrace();
