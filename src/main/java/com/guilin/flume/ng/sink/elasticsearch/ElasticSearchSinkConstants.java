...
public class ElasticSearchSinkConstants {
    ...
    public static final String DEFAULT_SERIALIZER_CLASS = "com.guilin.flume.ng.sink.elasticsearch.ElasticSearchLogStashEventSerializer";
    public static final String DEFAULT_INDEX_NAME_BUILDER_CLASS = "com.guilin.flume.ng.sink.elasticsearch.TimeBasedIndexNameBuilder";
